...
--
-- __N:__ Apenas @Terra@ é destrutível.
...
--
-- __N:__ Apenas @Terra@ ou @Pedra@ são opacos.
...
--
-- __N:__ Uma posição está livre se não contiver um terreno opaco.
...
--
-- __N:__ Uma posição está livre se o mapa estiver livre e se não estiver já uma minhoca ou um barril nessa posição.
...
--
-- __N__: Só terrenos @Terra@ pode ser destruídos.
